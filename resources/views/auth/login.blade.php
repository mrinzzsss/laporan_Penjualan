...
<body class="bg-slate-100 min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-6">
            <span class="inline-flex w-12 h-12 rounded-xl bg-sky-400 items-center justify-center text-white font-bold text-lg mb-3">KS</span>
            <h1 class="text-xl font-bold text-slate-800">Login Kasir</h1>
